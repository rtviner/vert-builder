...
## 3. Project Structure
To keep the `app/frontend/` folder clean, categorize specialized logic here:
* **`frontend/components`:** component definitions
* **`frontend/hooks`:** custom hooks
* **`frontend/types`:** typescript interfaces
* **`frontend/services`:** logic shared across components
